...
```
john --format=netntlm /Wifi-ForgeR/Framework/loot/wpa_handshake_capture* --mask='Badpass?d' --min-length=7 --max-length=13 --pot=/Wifi-ForgeR/Framework/loot/output.pot
```
